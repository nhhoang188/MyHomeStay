...
<section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/d518d9cd1ec845860c784bfe6558eb5f.jpg);">
    <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
            <div class="col-md-12 text-center">

                <div class="mb-5 element-animate">
                    <h1>Welcome To HomeStay Booking Vjp Pr0</h1>
                    <p>Discover our world's #1 Luxury Room For VIP.</p>
                    <p><a href="booking" class="btn btn-primary">Book Now</a></p>
                </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="heading-wrap text-center element-animate">
                    ...
                    <p class="mb-5">We are going not to escape life, we are to escape ourselves! If you don't know where you are going, all paths help you to get there
                    </p>
                    <p><a href="rooms" class="btn btn-primary btn-sm">All HomeStay</a></p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12 heading-wrap text-center">
                <h4 class="sub-heading">Our HomeStay</h4>
        ...
        <div class="row ">
            <div class="col-md-7">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="images/room_1.jpg" alt="Generic placeholder image" class="img-fluid">
                  ...
                  <span>
                    ...
                    <div class="media-body">
                        <h3 class="mt-0"><a href="rooms?action=show&id=1">Mountain View Homestay</a></h3>
                        <ul class="room-specs">
                            <li><span class="ion-ios-people-outline"></span> 2 guests/rooms</li>
            ...
            <div class="col-md-5 room-thumbnail-absolute">
                <a href="rooms?action=show&id=6" class="media d-block room bg first-room" style="background-image: url(images/room_6.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                  <span>
                   HOMESTAY BAN BUA
                ...
                <a href="rooms?action=show&id=3" class="media d-block room bg second-room" style="background-image: url(images/room_3.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                  <span>
                    Moc chau Hobbiton
