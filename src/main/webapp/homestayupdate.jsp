                        ...
                        <div class="table-responsive">
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <c:forEach var="item" items="${homestays}">
                                    <tbody>
                                    <tr>
                                        <td> <a href="/admin?action=edit&id=${item.homestayID}">Edit</a></td>
                                        <td> <a href="/admin?action=delete&id=${item.homestayID}">Delete</a> </td>
                                        <td>${item.tenhomestay}</td>
                                        <td>${item.diachi}</td>
                                        <td>${item.sdt}</td>
                                        <td>${item.giaphong}</td>
                                        <td>${item.sophong}</td>
                                        <td>${item.tienich}</td>
                                        <td>${item.thongtin}</td>
                                        <td>${item.thongtin1}</td>
                                        <td>${item.thongtin2}</td>
                                        <td>${item.thongtin3}</td>
                                        <td>${item.anh}</td>
                                        <td>${item.anh}</td>
                                        <td>${item.anh}</td>
                                        <td>${item.anh}</td>
