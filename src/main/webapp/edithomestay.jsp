                        ...
                        <div class="table-responsive">
                            ...
                            <table id="zero_config" class="table table-striped table-bordered">
                                ...
                                <c:forEach var="item" items="${homestays}">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><input type="number" name="_name">${item.tenhomestay}</td>
                                        <td><input type="text" name="_diachi">${item.diachi}</td>
                                        <td><input type="number" name="_sdt">${item.sdt}</td>
                                        <td><input type="number" name="_giaphong">${item.giaphong}</td>
                                        <td><input type="number" name="_sophong">${item.sophong}</td>
                                        <td><input type="text" name="_tienich">${item.tienich}</td>
                                        <td><input type="text" name="_thongtin">${item.thongtin}</td>
                                        <td><input type="text" name="_thongtin1">${item.thongtin1}</td>
                                        <td><input type="text" name="_thongtin2">${item.thongtin2}</td>
                                        <td><input type="text" name="_thongtin3">${item.thongtin3}</td>
                                        <td><input type="text" name="_anh">${item.anh}</td>
                                        <td><input type="text" name="_anh2">${item.anh}</td>
                                        <td><input type="text" name="_anh3">${item.anh}</td>
                                        <td><input type="text" name="_anh4">${item.anh}</td>
                                    </tr>
                                    </tbody>
                                </c:forEach>
                                <tfoot>
