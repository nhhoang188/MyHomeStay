...
<section class="site-hero site-hero-innerpage overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/moc-chau-la-o-dau-3.jpg);">
    <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
            <div class="col-md-12 text-center">
                ...
                <div class="mb-5 element-animate">
                    <h1>Our Rooms</h1>
                    <p>Discover our world's #1 Booking HomeStay.</p>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="${item.anh}" alt="Generic placeholder image" class="img-fluid">
                  ...
                  <span>
                    ...
                    <div class="media-body">
                        <h3 class="mt-0"><a href="/rooms?action=show&id=${item.homestayID}">${item.tenhomestay}</a></h3>
                        <ul class="room-specs">
                            <li><span class="ion-ios-people-outline"></span>2/room </li>
